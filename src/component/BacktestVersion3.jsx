...
const BacktestVersion3 = () => {
        ...
        axios(config)
            .then(function (res) {
                ...
                if(response)
                {
                    ...
                    setd(JSON.parse(response.d))
                    sete(JSON.parse(response.e))
                    // setresponse(true)
                }
                setloader(false);
                // navigate('/success');
    ...
    const handlenifty = () => {
        setcolor1(""); setcolor("black");
        console.log(color);
        console.log(color1)
    }
    const handlebanknifty = () => {
        setcolor(""); setcolor1("black");
        console.log(color);
        console.log(color1)
    }

    return (
        <div className='flex flex-row w-screen mb-10 text-black'>
                <div className=" ml-3 mr-5 w-1/6" style={{backgroundColor: "white"}}>
            ...
            <div className="w-5/6 font-bold" style={{ backgroundColor:"#e9effa",color:"#98979b"}}>
                <NavbarVersion2/>
                <div className="grid grid-cols-6 mt-10 bg-white rounded-xl mr-5 ml-5 pb-5 max-md:grid-cols-3" style={{color:"#98979b"}}>
                    <div className="flex flex-col">
                        <div className="mt-3 ml-3 mr-10  text-center font-normal">
                            Trade Symbols
                        </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 text-center justify-center mt-2 ml-10 mr-10 w-36  rounded-xl">
                            <div style={{ color: color,borderColor:color }} className="rounded-l-xl h-8 border-solid border-2" onClick={handlenifty}>
                                Weekly
                            </div>
                            <div style={{ color: color1,borderColor:color1 }} className="rounded-r-xl h-8 border-solid border-2" onClick={handlebanknifty}>
                                Monthly
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 text-center justify-center mt-2 ml-10 mr-10 w-36  rounded-xl">
                            <div style={{ color: intracolory,borderColor:intracolory }} className="rounded-l-xl h-8 border-solid border-2 " onClick={() => { setintracolorn(""); setintracolory("black"); setintraday("Yes") }}>
                                Yes
                            </div>
                            <div style={{ color: intracolorn,borderColor:intracolorn }} className="rounded-r-xl h-8 border-solid border-2 " onClick={() => { setintracolory(""); setintracolorn("black"); setintraday("Yes") }}>
                                No
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 text-center justify-center mt-2 ml-10 mr-10 w-36  rounded-xl">
                            <div style={{ color: halty,borderColor:halty}} className="rounded-l-xl h-8 border-solid border-2" onClick={() => { sethalty("black"); sethaltn(""); sethalt("Yes") }}>
                                Yes
                            </div>
                            <div style={{ color: haltn,borderColor:haltn }} className="rounded-r-xl h-8 border-solid border-2" onClick={() => { sethaltn("black"); sethalty(""); sethalt("Yes") }}>
                                No
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 text-center justify-center mt-2 ml-10 mr-10 w-36  rounded-xl">
                            <div style={{ color: fixedratey,borderColor:fixedratey }} className="rounded-l-xl h-8 border-solid border-2" onClick={() => { setfixedraten(""); setfixedratey("black"); setFixedRate("Yes") }}>
                                Yes
                            </div>
                            <div style={{ color: fixedraten,borderColor:fixedraten}} className="rounded-r-xl h-8 border-solid border-2" onClick={() => { setfixedratey(""); setfixedraten("black"); setFixedRate("Yes") }}>
                                No
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 text-center justify-center mt-2 ml-10 mr-10 w-36  rounded-xl">
                            <div style={{ color: expiryfixedy,borderColor:expiryfixedy }} className="rounded-l-xl h-8 border-solid border-2" onClick={() => { setexpiryfixedn(""); setexpiryfixedy("black"); setExpiryfixed("Yes") }}>
                                Yes
                            </div>
                            <div style={{ color: expiryfixedn,borderColor:expiryfixedn }} className="rounded-r-xl h-8 border-solid border-2" onClick={() => { setexpiryfixedy(""); setexpiryfixedn("black"); setExpiryfixed("Yes") }}>
                                No
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="flex flex-col bg-white rounded-xl ml-5 mt-2 mb-5 mr-5">
                                <div className=" flex flex-row pb-5 ml-5 mr-5 mb-5 overflow-x-auto bg-inherit">
                                    ...
                                    <div className="flex flex-col ">
                                        ...
                                        <Select
                                            value={atm[key]}
                                            className="h-8 mt-2 ml-10 outline-0 border-black  text-center border-solid rounded-xl border-2 bg-inherit border-spacing-7 w-36"
                                            style={{ borderRadius: "0.75rem" }}
                                            onChange={(e) => {
                                                const inputdata = [...atm]
                                                inputdata[key] = e.target.value;
