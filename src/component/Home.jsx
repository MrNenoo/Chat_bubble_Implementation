...
const Home = () => {
    ...
    const [stoplosslower, setstoplosslower] = useState(10000)
    const [stoplossupper, setstoplossupper] = useState(10000)
    const [stoplosssteps, setstoplosssteps] = useState(10000)
    const [maxprofitupper, setmaxprofitupper] = useState(10000)
    const [maxprofitlower, setmaxprofitlower] = useState(10000)
    const [maxprofitsteps, setmaxprofitsteps] = useState(10000)
    const [halt, sethalt] = useState("Yes")
    const [investment, setinvestment] = useState(10000)
    const [starttime, setStartTime] = useState("09:30")
    const [endtime, setEndTime] = useState("03:25")
    ...
    const [timeGroups, setTimeGroups] = useState("0")
    ...
    useEffect(() => {
        if (leg === "") {
            ...
            setfirstexpirydate(Array(parseInt(leg)).fill("2020-01-03"))
    ...
    useEffect(() => {
        if (timeGroups === "") {
            ...
            setStartTimeArray(Array(parseInt(timeGroups)).fill("09:15"))
    ...
    const handleSymbol = async () => {
        ...
        try {
            ...
            if (response.data)
                setsymboldata(response.data.array)
    ...
    return (
        <>
            ...
            <div className="shadow-lg m-10">
                <h2 className="text-center justify-center text-3xl text-white font-bold bg-gradient-to-r from-zinc-500  to-blue-900   rounded-t-lg pt-3 pb-3">Backtest Portal</h2>
               
                <div className="p-10 bg-gradient-to-b from-zinc-900 via-slate-600 to-zinc-400 rounded-b-lg" >
                    {/* ###### 1st Box #### */}
                    <div className="lg:flex lg:flex-row lg:mb-2 max-md:grid max-md:grid-cols-2">
                        <div className="flex flex-row max-md:grid max-md:grid-cols-2 max-md:mb-1">
                            ...
                            <input type="text" required placeholder="legs" className="h-8 w-12 mr-4 bg-inherit text-white outline-0 border-b-slate-50 text-center border-solid rounded border-2 max-md:mb-1" value={leg} onChange={(e) => { setleg(e.target.value); }}></input>
                                    ...
                                    lotarray.map((item, key) => {
                                        return (
                                            <div className="flex flex-row">
                                                <input type="text" placeholder="legs" className="h-8 w-12 bg-inherit text-white outline-0 border-b-slate-50 text-center border-solid rounded border-2 " value={lotarray[key]} onChange={(e) => {
                        ...
                        <div className="flex flex-row ml-2 max-md:grid max-md:grid-cols-1 max-md:mb-1">
                            <label className=" inline-block text-white mr-4" style={{ fontSize: "15px", fontFamily: "Arial, Helvetica, sans-serif" }}>Type of Legs:</label>
                            <div className="grid grid-cols-3 gap-1 overflow-x-hidden overflow-y-auto h-8 mr-4 max-sm:grid-cols-1 max-md:grid-cols-1">
                                {
                                    ...
                                    legarray.map((item, key) => {
                                        return (
                                            <Select
                                                value={legarray[key]}
                                                label=""
                                                className="h-8  bg-inherit text-white border-spacing-7 w-18 border-solid border-2 rounded"
                                                onChange={(e) => {
                        ...
                        <div className="flex flex-row max-md:grid max-md:grid-cols-2">
                            <label className=" inline-block text-white mr-4" style={{ fontSize: "15px", fontFamily: "Arial, Helvetica, sans-serif" }}>D:</label>
                            <div className="grid grid-cols-3 gap-1 overflow-x-hidden overflow-y-auto h-8 mr-4 max-sm:grid-cols-1 max-md:grid-cols-1">
                                {
                                    ...
                                    darray.map((item, key) => {
                                        return (
                                            ...
                                            <input type="text" placeholder="legs" className="h-8 w-12 bg-inherit text-white outline-0 border-b-slate-50 text-center border-solid rounded border-2 " value={item} onChange={(e) => {
                    ...
                    <div className="grid grid-cols-2 mb-2">
                        <div className="flex flex-row mb-2" id="d_times">
                            ...
                            <input type="text" placeholder="No. Of Times You want to Iterate" className="h-8  w-12 bg-inherit text-white outline-0 border-b-slate-50 text-center border-solid rounded border-2 mr-2" value={dIncrement} onChange={(e) => { setdincrement(e.target.value) }}></input>
                        </div>
                        <div className="flex flex-row mb-2" id="d_times">
                            <label className=" inline-block text-white mr-2" style={{ fontSize: "15px", fontFamily: "Arial, Helvetica, sans-serif" }}>D_Increment:</label>
                    ...
                    <div className="flex flex-row">
                        ...
                        <input type="text" placeholder="legs" className="h-8 mr-4  bg-inherit text-white outline-0 border-b-slate-50 w-12 text-center border-solid rounded border-2 " value={t} onChange={(e) => { sett(e.target.value); }}></input>
                        <label className=" inline-block text-white mr-4" style={{ fontSize: "15px", float: "right", fontFamily: "Arial, Helvetica, sans-serif" }}>T:</label>
                        <div className="grid grid-cols-12 gap-1 overflow-x-hidden overflow-y-auto h-8 mb-2 max-sm:grid-cols-3 max-md:grid-cols-6">
                            {
                                ...
                                tarray.map((item, key) => {
                                    return (
                                        <div className="box">
                                            <input type="text" placeholder="legs" className="h-8 w-12 bg-inherit text-white outline-0 border-b-slate-50 text-center border-solid rounded border-2 " value={tarray[key]} onChange={(e) => {
                    ...
                    <div className="grid grid-cols-2 mb-2 max-md:grid-cols-1">
                        <div className="flex flex-row max-md:mb-1">
                        ...
                        <div className="grid grid-cols-1 gap-1 overflow-x-hidden overflow-y-auto h-8 mr-4">
                            {
                                firstexpirydate.map((item, key) => {
                                    return (
                                        <input placeholder="Expiry Date" className="h-8  bg-inherit text-white outline-0 border-b-slate-50 w-36 text-center border-solid rounded border-2 max-md:mb-1" required type="date" value={item} variant="outlined" onChange={(e) => {
                                ...
                                expiryFixed.map((item, key) => {
                                    return (
                                        ...
                                        <Select
                                            ...
                                            className="h-8  bg-inherit text-white outline-0 border-solid border-2 rounded border-b-slate-50 w-36 max-md:mb-1"
                                            onChange={(e) => {
                                ...
                                incrementexpiry.map((item, key) => {
                                    return (
                                        ...
                                        <Select
                                            ...
                                            value={item}
                                            className="h-8  border-solid border-2 rounded bg-inherit text-white outline-0 border-b-slate-50 w-36 max-md:mb-1"
                                            style={{ color: "white" }}
                                            label="ExpiryInc"
                                            onChange={(e) => {
                    ...
                    <div className="flex flex-row mb-2 max-md:grid max-md:grid-cols-1" id="tgval">
                        <div className="grid grid-cols-1 gap-1 overflow-x-hidden overflow-y-auto h-8 mr-4 max-md:mb-1">
                            {
                                startTimeArray.map((item, key) => {
                                    return (
                                        <div className="flex flex-row max-md:grid max-md:grid-cols-2">
                                            <label className=" inline-block text-white mr-2" style={{ fontSize: "15px", fontFamily: "Arial, Helvetica, sans-serif" }}>Start Time:</label>
                                            <input placeholder="Start Time" className="h-8  bg-inherit w-36 text-white outline-0 border-b-slate-50 text-center border-solid rounded border-2 max-md:mb-1 " required value={startTimeArray[key]} sx={{ marginRight: "10px" }} variant="outlined" type="time" onChange={(e) => {
                        ...
                        <div className="grid grid-cols-1 gap-1 overflow-x-hidden overflow-y-auto h-8 mr-4 max-md:mb-1">
                            {
                                endTimeArray.map((item, key) => {
                                    return (
                                        <div className="flex flex-row max-md:grid max-md:grid-cols-2">
                                            <label className=" inline-block text-white mr-2" style={{ fontSize: "15px", fontFamily: "Arial, Helvetica, sans-serif" }}>End Time:</label>
                                            <input placeholder="End Time" className="h-8 bg-inherit w-36 text-white outline-0 border-b-slate-50  text-center border-solid rounded border-2 max-md:mb-1" required value={endTimeArray[key]} variant="outlined" type="time" onChange={(e) => {
                        ...
                        <div className="flex flex-row max-md:grid max-md:grid-cols-2">
                            <label className=" inline-block text-white mr-4" style={{ fontSize: "15px", fontFamily: "Arial, Helvetica, sans-serif" }}>OUTPUT FOLDER NAME:</label>
